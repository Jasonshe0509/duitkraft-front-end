                  ...
                  <div className="register-box max-w-[380px] lg:max-w-[480px]">
                    <form>
                      ...
                      <div className="user-box grid grid-cols-2 gap-3">
                        <div>
                          <select name="country" className='mb-[30px]'>
                        ...
                        <div>
                          <select name="gender" className='mb-[30px]'>
                      ...
                      <div className="user-box">
                        ...
                        <div className='grid grid-cols-5 gap-3'>
                          ...
                          <input type="text" name="" value="172903819" placeholder='Contact Number' className='col-span-3' />
                        </div>
                      </div>
                      <div className="user-box">
                        <input
                        ...
                        <div className='flex absolute right-0 text-fontColor' style={{ top: "10px" }}>
                        </div>
                      </div>
                      <div className='user-box'>
