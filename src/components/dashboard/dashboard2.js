                  ...
                  {wee.map((item,i) => (
                    ...
                    <thead className="thead-light " >
                      ...
                      <tr> 
                        ...
                        <th className=" bg-white px-1 mx-1 inline-block text-blueGray-500 align-middle border-solid border-blueGray-100 my-3 text-xs border-l-0 border-r-0 whitespace-nowrap font-semibold text-left">
                          {item.mon}
                        </th>
